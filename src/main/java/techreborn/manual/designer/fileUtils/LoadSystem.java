        ...
        if (folder != null) {
            ...
            if (!masterJson.exists()) {
                ...
                for (Entry entry : format.entries) {
                    ...
                    if(ManualCategories.categories.containsKey(entry.category)){
                        parentTree = ManualCategories.categories.get(entry.category);
                    } else {
                        parentTree = ManualCategories.createNewCategorie(entry.category);
                    }
